...
export const englishTranslations = {
  ...
  costManagement: {
    ...
    subtitle: 'Monitor service costs and manage budgets',
    summary: {
    ...
    alerts: {
      title: 'Budget Alerts',
      allWithinBudget: 'All services are within budget',
      overBudget: '%{service} is at %{usage}% of budget ($%{actual} / $%{budget})',
      nearBudget: '%{service} is approaching budget at %{usage}% ($%{actual} / $%{budget})',
    },
    tco: {
      title: '4-Year Total Cost of Ownership',
      grandTotal: '4-Year Grand Total',
      infraOnly: '4-Year Infrastructure',
      devtoolOnly: '4-Year Dev Tools',
      insight: 'Key Insight',
      devtoolShare: 'Dev tools',
      insightDesc: 'Without dev tools, 4yr cost drops to',
      cumulativeChart: 'Cumulative Cost by Year',
      year: 'Year',
    ...
    freeTierUtil: {
      ...
      servicesOnFree: 'services at $0/mo',
      estimatedSavings: 'Est. Monthly Savings',
      vsLowestPaid: 'vs lowest paid tier',
      fourYearSavings: '4-Year Savings',
      byUsingFree: 'by using free tiers',
      free: 'FREE',
      freeAvailable: 'Free tier available',
    },
    perfMatrix: {
      title: 'Performance vs Cost',
      subtitle: 'Compare what you get at each pricing tier. At $0, performance is limited to free-tier allowances.',
      service: 'Service',
      tier1: 'Free / Low',
      tier2: 'Current',
      tier3: 'Next Tier',
